...
use SigRH\Entity\TipoColaborador as TipoColaboradorEntity;

class TipoColaborador extends AbstractRepository {

    public function getQuery($search = array()) {
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select('t')
                ->from(TipoColaboradorEntity::class, 't')
