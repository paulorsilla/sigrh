...
use SigRH\Entity\GrauInstrucao as GrauInstrucaoEntity;

class GrauInstrucao extends AbstractRepository {

    public function getQuery($search = array()) {
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select('g')
                ->from(GrauInstrucaoEntity::class, 'g')
                ->orderby('g.ordem','ASC');
